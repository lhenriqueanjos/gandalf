...
--
-- Host: 127.0.0.1
-- Generation Time: 29-Jun-2016 às 20:05
...
INSERT INTO `acesso` (`id`, `id_tag`, `id_sala`, `data_hora`) VALUES
(1, 1, 1, '2016-06-03 11:00:00'),
(2, 2, 1, '2016-06-03 10:00:00'),
(3, 1, 1, '2016-06-05 19:00:00'),
(4, 2, 1, '2016-06-04 19:00:00'),
(5, 2, 1, '2016-06-05 19:00:00'),
(6, 3, 1, '2016-06-08 19:00:00'),
(7, 4, 1, '2016-06-10 19:00:00'),
(8, 4, 1, '2016-06-12 19:00:00');

-- --------------------------------------------------------

--
-- Estrutura da tabela `categoria_tag`
--
...
--
-- Extraindo dados da tabela `categoria_tag`
--

INSERT INTO `categoria_tag` (`id`, `tipo`) VALUES
(1, 'Comum'),
(2, 'Master');
...
INSERT INTO `categoria_usuario` (`id`, `tipo`) VALUES
(1, 'Administrador'),
(2, 'Cliente');
...
INSERT INTO `permissao` (`id`, `id_sala`, `id_tag`, `hora_inicio`, `hora_fim`, `data_inicio_permissao`, `data_fim_permissao`, `segunda`, `terca`, `quarta`, `quinta`, `sexta`, `sabado`, `domingo`) VALUES
(1, 1, 1, '08:00:00', NULL, '2016-06-01', NULL, 1, 1, 1, 1, 1, 1, 1),
(2, 1, 2, '06:00:00', NULL, '2016-06-03', NULL, 1, NULL, 1, NULL, 1, NULL, NULL),
(3, 1, 3, '06:00:00', NULL, '2016-06-07', NULL, NULL, 1, NULL, 1, NULL, NULL, NULL),
(4, 1, 4, '07:00:00', '07:00:00', '2016-06-09', '2016-06-15', NULL, NULL, NULL, 1, 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `rel_usuario_tag`
--
...
--
-- Extraindo dados da tabela `rel_usuario_tag`
--

INSERT INTO `rel_usuario_tag` (`id`, `id_usuario`, `id_tag`, `data_inicio`, `hora_inicio`) VALUES
(1, 2, 1, '2016-06-01', '07:00:00'),
(2, 2, 5, '2016-06-02', '05:00:00'),
(3, 3, 2, '2016-06-02', '11:00:00'),
(4, 4, 3, '2016-06-06', '09:00:00'),
(5, 5, 4, '2016-06-09', '08:00:00');
...
INSERT INTO `sala` (`id`, `numero`, `nome`, `descricao`) VALUES
(1, 101, 'Laboratório 1', 'laboratório de informática para pesquisas');
...
INSERT INTO `tag` (`id`, `id_categoria`, `codigo`, `senha`) VALUES
(1, 2, '111111111', ''),
(2, 1, '222222222', ''),
(3, 1, '333333333', ''),
(4, 1, '444444444', ''),
...
INSERT INTO `usuario` (`id`, `id_categoria`, `matricula`, `nome`, `departamento`, `rua`, `numero`, `bairro`, `cep`, `cidade`, `estado`, `telefone`, `cpf`, `email`, `foto`, `senha`) VALUES
(1, 2, 12345, 'Lucas F', 'TADS', 'Teste1', 123, 'Teste2', '80000000', 'Curitiba', 'Paraná', '4199999999', '05294250926', 'lucascampos@ufpr.br', NULL, ''),
(2, 1, 12345, 'Lucas', 'TADS', 'Rua Padre Camargo', 12345, 'Alto da GlÃ³ria', '80.060-24', 'Curitiba', 'PR', '(12) 3456-7890', '052.942.509', 'lucascampos@ufpr.br', '', 0x3832376363623065656138613730366334633334613136383931663834653762),
(3, 2, 12345, 'Gabriel', 'Teste', 'Avenida Coronel Francisco HerÃ¡clito dos Santos', 123, 'Jardim das AmÃ©ricas', '81.530-90', 'Curitiba', 'PR', '(99) 9999-9999', '475.835.942', 'gabriel@ufpr.br', '', 0x3832376363623065656138613730366334633334613136383931663834653762),
(4, 2, 12344, 'Luiz Henrique', 'TAdS', 'Avenida Prefeito Lothario Meissner', 8798, 'Jardim BotÃ¢nico', '80.210-17', 'Curitiba', 'PR', '(88) 8888-8888', '298.004.986', 'luiz@ufpr.br', '', 0x3832376363623065656138613730366334633334613136383931663834653762),
(5, 2, 8978, 'Luiz Antonio Passos', 'CoordenaÃ§Ã£o', 'Teste', 8798, 'Teste', '80.200-30', 'Teste', 'PR', '(77) 7777-7777', '288.877.155', 'teste@ufpr.br', '', 0x3832376363623065656138613730366334633334613136383931663834653762);
...
ALTER TABLE `acesso`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_acesso_tag` (`id_tag`),
  ADD KEY `fk_acesso_sala` (`id_sala`);

--
-- Indexes for table `categoria_tag`
--
...
ALTER TABLE `permissao`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_permissao_tag` (`id_tag`),
  ADD KEY `fk_permissao_sala` (`id_sala`);

--
-- Indexes for table `rel_usuario_tag`
--
ALTER TABLE `rel_usuario_tag`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_rel_usuario_tag_tag` (`id_tag`),
  ADD KEY `fk_rel_usuario_tag_usuario` (`id_usuario`);
...
ALTER TABLE `tag`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_tag_categoria_tag` (`id_categoria`);
...
ALTER TABLE `usuario`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_usuario_categoria_usuario` (`id_categoria`);
...
--
-- AUTO_INCREMENT for table `categoria_tag`
--
ALTER TABLE `categoria_tag`
...
--
-- AUTO_INCREMENT for table `rel_usuario_tag`
--
ALTER TABLE `rel_usuario_tag`
...
--
ALTER TABLE `acesso`
  ADD CONSTRAINT `fk_acesso_sala` FOREIGN KEY (`id_sala`) REFERENCES `sala` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_acesso_tag` FOREIGN KEY (`id_tag`) REFERENCES `tag` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `permissao`
--
ALTER TABLE `permissao`
  ADD CONSTRAINT `fk_permissao_sala` FOREIGN KEY (`id_sala`) REFERENCES `sala` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_permissao_tag` FOREIGN KEY (`id_tag`) REFERENCES `tag` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `rel_usuario_tag`
--
ALTER TABLE `rel_usuario_tag`
  ADD CONSTRAINT `fk_rel_usuario_tag_tag` FOREIGN KEY (`id_tag`) REFERENCES `tag` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_rel_usuario_tag_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `tag`
--
ALTER TABLE `tag`
  ADD CONSTRAINT `fk_tag_categoria_tag` FOREIGN KEY (`id_categoria`) REFERENCES `categoria_tag` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_usuario_categoria_usuario` FOREIGN KEY (`id_categoria`) REFERENCES `categoria_usuario` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
